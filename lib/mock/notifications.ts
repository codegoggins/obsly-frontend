...
export const NOTIFICATIONS: Notification[] = [
  ...
  { id: "n2", tone: "danger", icon: "bug", title: "New issue · OBS-4821", body: "TypeError: Cannot read properties of undefined (reading 'total')", time: "4m", unread: true, href: "/issues" },
  ...
  { id: "n4", tone: "danger", icon: "refresh", title: "Regression · OBS-4790 reopened", body: "TimeoutError started happening again after release 2.14.0.", time: "1h", unread: false, href: "/issues" },
  { id: "n5", tone: "brand", icon: "user", title: "Mara mentioned you", body: "“can you take a look at the card_declined spike?” on OBS-4815", time: "3h", unread: false, href: "/issues" },
